...
A visual explorer for unconventional, joke, and genuinely terrible sorting algorithms. Watch Bogo Sort shuffle randomly into oblivion, Stalin Sort purge anything out of line, and Thanos Sort dust exactly half the array. Two real sorting algorithms are included for comparison, so you can see just how bad the rest actually are.
...
- Adjustable array size (8-60 elements) and speed (Slowest to Fastest)
